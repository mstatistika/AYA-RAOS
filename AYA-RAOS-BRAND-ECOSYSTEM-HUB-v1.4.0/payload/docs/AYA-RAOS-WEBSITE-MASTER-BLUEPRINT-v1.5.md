...
**Decision Log coverage:** Through DL-594
**Implementation authority:** Sunda visual baseline v1.3 and Phase 2 order/B2B persistence are approved on staging. Brand Ecosystem Hub v1.4 is the active preview scope. Shipping, payment, SEO launch, and Production Launch remain gated.
...
AYA RAOS functions as the master-brand and public ecosystem hub. Direct visitors must understand the umbrella structure before or alongside exposure to the current hero product.
...
3. Camilan & Minuman — AYA Snacks & Drinks.
