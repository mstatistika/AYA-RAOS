...
- Active implementation scope: **Brand Ecosystem Hub v1.4 preview**
- Environment: **staging**
...
`index.html` berfungsi sebagai pintu masuk master brand. Landing page lini berfungsi sebagai marketing gateway yang dapat menjadi tujuan QR produk:
