  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    root.innerHTML = `<div class="product-detail-grid">
      ...
      <div class="purchase-panel">
        <div class="product-heading-meta"><a class="line-label line-${product.lineKey}" href="${linePage}">${window.AYA.escapeHTML(product.line)} →</a><small>${window.AYA.escapeHTML(product.category)}</small></div>
