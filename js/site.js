(() => {
  ...
  const loadMobilePublicUi = () => {
    ...
    window.setTimeout(() => {
      ...
      const script = document.createElement("script"); script.src = "js/mobile-public-ui.js?v=20260909-mobile-testimonials-parity-v1"; script.dataset.ayaMobilePublicUi = ""; document.body.append(script);
    }, 0);
  };
