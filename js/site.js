(() => {
  ...
  const headerMarkup = () => {
    ...
    const wordmarkHref = window.AYA_CONFIG?.previewAdminBypass ? "admin/index.html" : homeHref("beranda");
    const wordmarkLabel = window.AYA_CONFIG?.previewAdminBypass ? "AYA RAOS — Buka Admin Preview" : "AYA RAOS — Beranda";
    const lineLinks = {
    ...
    if (lineLinks[lineKey]) {
      ...
      return `<header class="site-header site-header-context" data-site-header>
        <div class="site-header-inner">
          <a class="wordmark" href="${wordmarkHref}" aria-label="${wordmarkLabel}"><span class="wordmark-lockup-wrap"><img class="wordmark-lockup" src="assets/visual/home-lock/header-logo-tight.png" width="190" height="70" alt="" aria-hidden="true"></span></a>
