...
def main():
    ap = argparse.ArgumentParser(description='Rollback AYA RAOS v1.5.0 preview package.')
    ...
    if data.get('package') != 'AYA-RAOS-AWARENESS-RESPONSE-ACTION-v1.5.0':
        print('ERROR: backup bukan milik package v1.5.0 ini.')
        return 2
    ...
    print('Backup :', backup)
    print('Repository kembali ke state sebelum installer v1.5.0 menyentuh payload files.')
    return 0
